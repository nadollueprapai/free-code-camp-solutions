...
const flashcard = document.querySelector("#flashcard") as HTMLDivElement;
const deleteButton = document.querySelector("#delete-btn") as HTMLButtonElement;
const cardsDisplay = document.querySelector("#cards-display") as HTMLDivElement;
const entryForm = document.querySelector("#entry-form") as HTMLFormElement;
const formFrontText = document.querySelector("#front-text") as HTMLTextAreaElement;
const formBackText = document.querySelector("#back-text") as HTMLTextAreaElement;
const addCardButton = document.querySelector("#add-card-button") as HTMLButtonElement;

const renderFlashcard = (selectedFlashcard: FlashCard) => {
